            ...
            <div className="container level__container">
                ...
                <div className="level__cards_xl level__cards_xl-right">
                    ...
                    <div className="level__card">
                        ...
                        <p className="level__p">
                            Штат ОсОО "МТК СМАРТ" состоит из талантливых и опытных сотрудников, которые с полной отдачей выполняют свои рабочие обязанности. Каждый специалист заинтересован в том, чтобы сотрудничество приносило вам только положительные впечатления.
                        </p>
                    </div>
                </div>
